...
- **--yes flag**: New flag to skip confirmation prompts for automated/non-interactive workflows. Use with caution as it bypasses safety checks. Currently applies to rollback confirmation.
